...
"""Ontology"""
ontology = Graph()
ontology.parse(r'F:\Documents\Semester_8\Tugas_Akhir\import\without_STEMMING\sumedanglarang3.owl')

"""Data Kata Tag"""
katatag = pd.read_csv(r'F:\Documents\Semester_8\Tugas_Akhir\import\without_STEMMING\kunci.csv')
...
""" Data Objek"""
df_objek = pd.read_csv(r'F:\Documents\Semester_8\Tugas_Akhir\import\without_STEMMING\objek.csv')
list_objek = df_objek.values.tolist()
list_objek[:5]

""" Data Properti"""
df_properti = pd.read_csv(r'F:\Documents\Semester_8\Tugas_Akhir\import\without_STEMMING\data.csv')
